...
<p align="center">
  <b>Full-Stack Engineer 🛠️ | Agentic AI & Solution Architecture 🤖 | React/Node/FastAPI ⚡ | DevOps on AWS 🐳</b><br/>
  <i>I own things end-to-end — frontend, backend, and infra — and ship them to production.</i>
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Python%2FFastAPI-%F0%9F%90%8D-28a745?style=for-the-badge" alt="Python FastAPI Badge"/>
  <img src="https://img.shields.io/badge/AWS%20DevOps-%F0%9F%90%B3-0db7ed?style=for-the-badge" alt="AWS DevOps Badge"/>
  <img src="https://img.shields.io/badge/CI%2FCD%20%7C%20GitHub%20Actions-%E2%9C%A8-ff69b4?style=for-the-badge" alt="CI/CD Badge"/>
</p>
...
- 🧩 Currently at **Findability Sciences**, owning solution architecture and full-stack delivery for the company's flagship **Agentic AI SaaS platform** ([Video Demo](https://www.findability.ai/en/agentic-ai-platform)) — a patent-drafting copilot in Python/FastAPI + React/TypeScript, driving **60%+ time savings** for IP law firms
- 🏦 Previously at **EduFund**, building the [EduFund App](https://play.google.com/store/apps/details?id=com.educationfund.edufund&hl=en_IN) ([App Store](https://apps.apple.com/in/app/edufund-mutual-funds-sip/id1538432722)), internal tools, and web portals
...
- 🐳 Own the whole stack top to bottom: **Node.js/Express.js & Python/FastAPI** backends, **Docker/Kubernetes on AWS**, CI/CD pipelines (GitHub Actions), microservices/microfrontends, and enterprise API integration
- 🔭 Current side projects: [**OIOT-APP**](https://oiot.app/), **cover-pilot**, **trishasync**, **Edu-Dashboard**, **3D Product Viewer**, **XFlix**
...
- 💬 Ask me about: React, Node/Express, FastAPI, AI agents, CI/CD & AWS deployments, or when to TypeScript-ify everything
...
- 🔁 OpenAI, Azure OpenAI, Groq, LangChain, Pinecone, pgvector, vector stores & tool orchestration
...
- 🔁 **CI/CD**: GitHub Actions, automated build/test/deploy pipelines, automated npm package publishing
- 🐳 **Containerization**: Docker, multi-stage builds, container orchestration with Kubernetes
- ☁️ **AWS**: S3, EKS/Kubernetes clusters, EC2, IAM, deployment & scaling of containerized services
- 🚀 **Deployment**: Zero-downtime releases, blue-green/rolling deployments, environment/config management
- 🧱 **Architecture**: Microservices & microfrontends, service isolation (e.g. GPU-isolated OCR workloads for low-latency processing)
- 📊 **Reliability**: Query/cost guardrails on data pipelines, latency optimization on billion-row datasets
- 🔧 **Workflows**: Git branching strategies, code review standards, Agile delivery
...
<p>
  ...
  <img src="https://img.shields.io/badge/-Amazon%20AWS-black?style=flat&logo=amazonaws" />
...
Own solution architecture and end-to-end delivery for an AI agent orchestration SaaS platform in production at Findability Sciences — agentic flows, tool calling, OAuth-based multi-tenant access, and a GPU-isolated multimodal (OCR) pipeline, deployed via Docker/Kubernetes on AWS with CI/CD.
...
**Stack**: React, TypeScript, Material UI, Python, FastAPI, Docker, Kubernetes, AWS

---

#### 🧮 LLM-Based Analytics on SAP HANA
LLM-powered analytics pipeline used by 800+ global managers, with guardrails on LLM-generated SQL (RBAC filters, partition pruning, cost checks) — cut query load ~70% and latency from ~60s to <3s on billion-row datasets. Dockerized and deployed onto the client's Kubernetes cluster.

**Stack**: Python, SQL, Docker, Kubernetes

---

#### 📚 GenAI-Powered LMS SaaS (Vridhee Innovations)
...
Sole frontend engineer for the end-to-end onboarding flow on a production-grade savings & investment app with more than half a million users. Built a GenAI chatbot for college-fee prediction via OpenAI APIs.
...
**Stack**: React Native, Redux, REST APIs, Node.js, Express.js, OpenAI API, Android, iOS
...
#### 🛒 E-Commerce Platform (HeadGear Audio)
Built an end-to-end e-commerce platform with a Python/FastAPI backend and SQL database, including analytics dashboards, third-party API integrations, and SEO optimizations.
